package com.ericorporation.autotesting.ericorporation.it;
...
public class SignInActionTest {
    ...
    public void testSignInWithValidData() throws InterruptedException {
        ...
        webDriver.get(INDEX_IT);

        Thread.sleep(3000);
        action.acceptCookie();

        Thread.sleep(1000);
        action.clickSignIn("ACCEDI");
        ...
        Thread.sleep(1000);
            if (webDriver.getCurrentUrl().equals("https://ericorporation.it/accedi/?status=failed")) {
                action.fillUserLogin("test@gmail.com");
        ...
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://ericorporation.it/selection-software-for-heat-exchanger/");
    ...
    public void testSignInWithEmptyData() throws InterruptedException {
        ...
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://ericorporation.it/accedi/?status=empty");
    ...
    public void testSignInWithReverseData() throws InterruptedException {
        ...
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://ericorporation.it/accedi/?status=failed");
