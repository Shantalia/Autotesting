...
public class PasswordUpdater extends ActionOnPage {

    public PasswordUpdater(WebDriver webDriver) {
        super(webDriver);
    }

    public void openProfileMenu() {
        getWebDriver().findElement(By.id("logged")).click();
    }

    public void goToChangePasswordPage() {
        getWebDriver().findElement(By.className("change-pass")).click();
    }

    public void fillOldPassword(String oldPassword) {
        getWebDriver().findElement(By.id("old-pass")).sendKeys(oldPassword);
    }

    public void fillNewPassword(String newPassword) {
        getWebDriver().findElement(By.id("new-pass-1")).sendKeys(newPassword);
    }

    public void repeatNewPassword(String newPassword) {
        getWebDriver().findElement(By.id("new-pass-2")).sendKeys(newPassword);
    }
